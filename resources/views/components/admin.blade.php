...
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" x-cloak>
    ...
    <script src="{{ asset('menu-editor/iconset/iconset-fontawesome-4.7.0.min.js') }}"></script>
    <script src="{{ asset('menu-editor/bootstrap-iconpicker.js') }}"></script>
    <script src="{{ asset('menu-editor/jquery-menu-editor.js') }}"></script>
